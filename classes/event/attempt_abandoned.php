...
/**
 * The mod_quizinvideo attempt abandoned event.
 *
...
/**
 * The mod_quizinvideo attempt abandoned event class.
 *
 * @property-read array $other {
 *      Extra information about event.
 *
 *      - int submitterid: id of submitter (null when trigged by CLI script).
 *      - int quizinvideoid: (optional) id of the quizinvideo.
 * }
 *
 * @package    mod_quizinvideo
 * @since      Moodle 2.6
...
class attempt_abandoned extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->relateduserid' has had their attempt with id '$this->objectid' marked as abandoned " .
            "for the quizinvideo with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventquizinvideoattemptabandoned', 'mod_quizinvideo');
    }
    ...
    static public function get_legacy_eventname() {
        return 'quizinvideo_attempt_abandoned';
    }
