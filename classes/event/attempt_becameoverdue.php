...
/**
 * The mod_quizinvideo attempt became overdue event.
 *
...
/**
 * The mod_quizinvideo attempt became overdue event class.
 *
...
class attempt_becameoverdue extends \core\event\base {
    ...
    public function get_description() {
        return "The quizinvideo attempt with id '$this->objectid' belonging to the quizinvideo with course module id '$this->contextinstanceid' " .
    ...
    public static function get_name() {
        return get_string('eventquizinvideoattempttimelimitexceeded', 'mod_quizinvideo');
    }
    ...
    static public function get_legacy_eventname() {
        return 'quizinvideo_attempt_overdue';
    }
