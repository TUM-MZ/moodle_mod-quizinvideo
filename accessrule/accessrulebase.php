...
/**
 * Base class for rules that restrict the ability to attempt a quizinvideo.
 *
...
/**
 * A base class that defines the interface for the various quizinvideo access rules.
 ...
 * @since     Moodle 2.2
 */
abstract class quizinvideo_access_rule_base {
    /** @var stdClass the quizinvideo settings. */
    protected $quizinvideo;
    /** @var quizinvideo the quizinvideo object. */
    protected $quizinvideoobj;
    /** @var int the time to use as 'now'. */
    protected $timenow;

    /**
     * Create an instance of this rule for a particular quizinvideo.
     * @param quizinvideo $quizinvideoobj information about the quizinvideo in question.
     * @param int $timenow the time that should be considered as 'now'.
     */
    public function __construct($quizinvideoobj, $timenow) {
        $this->quizinvideoobj = $quizinvideoobj;
        $this->quizinvideo = $quizinvideoobj->get_quizinvideo();
        $this->timenow = $timenow;
    }

    /**
     * Return an appropriately configured instance of this rule, if it is applicable
     * to the given quizinvideo, otherwise return null.
     * @param quizinvideo $quizinvideoobj information about the quizinvideo in question.
     * @param int $timenow the time that should be considered as 'now'.
     * @param bool $canignoretimelimits whether the current user is exempt from
     *      time limits by the mod/quizinvideo:ignoretimelimits capability.
     * @return quizinvideo_access_rule_base|null the rule, if applicable, else null.
     */
     ...
     *
     * @param mod_quizinvideo_preflight_check_form $quizinvideoform the form being built.
    ...
    /**
     * This is called when the current attempt at the quizinvideo is finished. This is
    ...
    /**
     * Information, such as might be shown on the quizinvideo view page, relating to this restriction.
     ...
     * this quizinvideo, then return true. This is used so we can know whether to display a
    ...
    /**
     * Add any fields that this rule requires to the quizinvideo settings form. This
     * method is called from {@link mod_quizinvideo_mod_form::definition()}, while the
    ...
    /**
     * Save any submitted settings when the quizinvideo settings form is submitted. This
     * is called from {@link quizinvideo_after_add_or_update()} in lib.php.
    ...
    /**
     * Delete any rule-specific settings when the quizinvideo is deleted. This is called
     * from {@link quizinvideo_delete_instance()} in lib.php.
     ...
     * here is probalby to read the code of {@link quizinvideo_access_manager::load_settings()}.
     *
     * If you have some settings that cannot be loaded in this way, then you can
     * use the {@link get_extra_settings()} method instead, but that has
     * performance implications.
     *
     * @param int $quizinvideoid the id of the quizinvideo we are loading settings for. This
     *     can also be accessed as quizinvideo.id in the SQL. (quizinvideo is a table alisas for {quizinvideo}.)
     ...
     */
    public static function get_settings_sql($quizinvideoid) {
        return array('', '', array());
    }
     ...
     */
    public static function get_extra_settings($quizinvideoid) {
        return array();
    }
}
