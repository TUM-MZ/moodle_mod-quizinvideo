@mod @mod_quizinvideo
Feature: Edit quizinvideo page - adding things
  In order to build the quizinvideo I want my students to attempt
  As a teacher
  I need to be able to add questions to the quizinvideo.
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | quizinvideo       | quizinvideo 1 | quizinvideo 1 for testing the Add menu | C1     | quizinvideo1    |
    And I log in as "teacher1"
    And I follow "Course 1"
    And I follow "quizinvideo 1"
    And I navigate to "Edit quizinvideo" node in "quizinvideo administration"
    Then I should see "Editing quizinvideo: quizinvideo 1"

  @javascript
  Scenario: Add some new question to the quizinvideo using '+ a new question' options of the 'Add' menu.
    And I open the "last" add to quizinvideo menu
    ...
    Then I should see "Editing quizinvideo: quizinvideo 1"
    And I should see "Essay 01 new" on quizinvideo page "1"

    And I open the "Page 1" add to quizinvideo menu
    And I follow "a new question"
    And I set the field "qtype_qtype_essay" to "1"
    And I press "submitbutton"
    Then I should see "Adding an Essay question"
    ...
    Then I should see "Editing quizinvideo: quizinvideo 1"
    And I should see "Essay 01 new" on quizinvideo page "1"
    And I should see "Essay 02 new" on quizinvideo page "1"
    ...
    And I should see "Essay 01 new" on quizinvideo page "1"
    And I should see "Essay 02 new" on quizinvideo page "1"
    And I should see "Essay 03 new" on quizinvideo page "1"
    ...
    And I should see "Essay 02 new" on quizinvideo page "1"
    And I should see "Essay 03 new" on quizinvideo page "1"
    And I should see "Essay 04 new" on quizinvideo page "1"
    ...
    And I should see "Essay 01 new" on quizinvideo page "1"
    And I should see "Essay 02 new" on quizinvideo page "1"
    And I should see "Essay 03 new" on quizinvideo page "2"
    And I should see "Essay 04 new" on quizinvideo page "2"
    ...
    And I should see "Essay 03 new" on quizinvideo page "2"
    And I should see "Essay 04 new" on quizinvideo page "2"
    And I should see "Essay for page 2" on quizinvideo page "2"

  @javascript
  Scenario: Add questions from question bank to the quizinvideo. In order to be able to
      add questions from question bank to the quizinvideo, first we create some new questions
    ...
    And I click on "Add to quizinvideo" "link" in the "Essay 03" "table_row"
    Then I should see "Editing quizinvideo: quizinvideo 1"
    And I should see "Essay 03" on quizinvideo page "1"

    # Add Essay 01 from question bank.
    And I open the "Page 1" add to quizinvideo menu
    And I follow "from question bank"
    And I click on "Add to quizinvideo" "link" in the "Essay 01" "table_row"
    Then I should see "Editing quizinvideo: quizinvideo 1"
    And I should see "Essay 03" on quizinvideo page "1"
    And I should see "Essay 01" on quizinvideo page "1"
    ...
    And I should see "Select a category"
    And I set the field "Select a category" to "Subcat 1"
    And I click on "Add to quizinvideo" "link" in the "Essay 02" "table_row"
    Then I should see "Editing quizinvideo: quizinvideo 1"
    And I should see "Essay 03" on quizinvideo page "1"
    And I should see "Essay 01" on quizinvideo page "1"
    And I should see "Essay 02" on quizinvideo page "1"
    ...
    And I should see "Essay 01" on quizinvideo page "1"
    And I should see "Essay 02" on quizinvideo page "1"
    And I should see "Random" on quizinvideo page "1"
    ...
    When I press "Go"
    And I should see "Essay 03" on quizinvideo page "1"
    And I should see "Essay 01" on quizinvideo page "2"
    And I should see "Essay 02" on quizinvideo page "3"
    And I should see "Random" on quizinvideo page "4"

    # Add a random question to page 4.
    And I open the "Page 4" add to quizinvideo menu
    And I follow "a new question" in the open menu
    And I set the field "qtype_qtype_essay" to "1"
    And I press "submitbutton"
    Then I should see "Adding an Essay question"
    ...
    And I should see "Essay 02" on quizinvideo page "3"
    And I should see "Random" on quizinvideo page "4"
    And I should see "Essay for page 4" on quizinvideo page "4"
