@mod @mod_quizinvideo
Feature: In order to create a quizinvideo that awards marks the way I want
  As a teacher
  I must be able to set the marks I want on the Edit quizinvideo page (even after the quizinvideo has been attempted).
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | quizinvideo       | quizinvideo 1 | C1     | quizinvideo1    | 20    | 2             | -1                    |
  ...
  @javascript
  Scenario: Verify the number of decimal places shown is what the quizinvideo settings say it should be.
