        ...
        foreach ($data->getRows() as $questiondata) {
            ...
            if (!isset($questiondata[2]) || $questiondata[2] === '') {
                ...
                if (!is_numeric($questiondata[2]) || $maxmark < 0) {
                    throw new ExpectationException('When adding questions to a quizinvideo, the max mark must be a positive number.',
                            $this->getSession());
                }
            }
            ...
            if ($page <= 0 || (string) $page !== $rawpage) {
                throw new ExpectationException('When adding questions to a quizinvideo, the page number must be a positive integer.',
                        $this->getSession());
            }
