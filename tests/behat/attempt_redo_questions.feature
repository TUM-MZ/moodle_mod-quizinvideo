@mod @mod_quizinvideo
Feature: Allow students to redo questions in a practice quizinvideo, without starting a whole new attempt
  In order to practice particular skills I am struggling with
  As a student
  I need to be able to redo each question in a quizinvideo as often as necessary without starting a whole new attempt, if my teacher allows it.
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | quizinvideo       | quizinvideo 1 | quizinvideo 1 description | C1     | quizinvideo1    | immediatefeedback  | 1                |
  ...
  Scenario: Teachers reviewing can see all the qestions attempted in a slot
    ...
    And I navigate to "Statistics" node in "quizinvideo administration > Results"
    And I follow "TF1"
    And "False" row "Frequency" column of "quizinvideoresponseanalysis" table should contain "100.00%"
    And "True" row "Frequency" column of "quizinvideoresponseanalysis" table should contain "0.00%"
    And "[No response]" row "Frequency" column of "quizinvideoresponseanalysis" table should contain "100.00%"
