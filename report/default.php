...
/**
 * Base class for quizinvideo report plugins.
 *
 ...
 * This class displays quizinvideo reports.  Because it is called from
 * within /mod/quizinvideo/report.php you can assume that the page header
 * and footer are taken care of.
 *
 * This file can refer to itself as report.php to pass variables
 * to itself - all these will also be globally available.  You must
 * pass "id=$cm->id" or q=$quizinvideo->id", and "mode=reportname".
 *
 * @copyright 1999 onwards Martin Dougiamas and others {@link http://moodle.com}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class quizinvideo_default_report {
    const NO_GROUPS_ALLOWED = -2;

    /**
     * Override this function to displays the report.
     * @param $cm the course-module for this quizinvideo.
     * @param $course the coures we are in.
     * @param $quizinvideo this quizinvideo.
     */
    public abstract function display($cm, $course, $quizinvideo);
     ...
     */
    public function print_header_and_tabs($cm, $course, $quizinvideo, $reportmode = 'overview') {
        global $PAGE, $OUTPUT;

        // Print the page header.
        $PAGE->set_title($quizinvideo->name);
