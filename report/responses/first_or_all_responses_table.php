...
/**
 * This file defines the quizinvideo responses table for showing first or all tries at a question.
 *
...
/**
 * This is a table subclass for displaying the quizinvideo responses report, showing first or all tries.
 *
 * @package   quizinvideo_responses
 * @copyright 2014 The Open University
 * @author    Jamie Pratt <me@jamiep.org>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class quizinvideo_first_or_all_responses_table extends quizinvideo_last_responses_table {
        ...
        foreach ($this->rawdata as $attempt) {
            ...
            for ($try = 1; $try <= $maxtriesinanyslot; $try++) {
                ...
                if ($try !== $maxtriesinanyslot) {
                    $newtablerow->state = quizinvideo_attempt::IN_PROGRESS;
                }
                $newtablerow->try = $try;
