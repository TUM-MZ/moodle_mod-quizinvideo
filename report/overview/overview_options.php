...
/**
 * Class to store the options for a {@link quizinvideo_overview_report}.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class quizinvideo_overview_options extends mod_quizinvideo_attempts_report_options {
    ...
    public function setup_from_user_preferences() {
        ...
        $this->slotmarks = get_user_preferences('quizinvideo_overview_slotmarks', $this->slotmarks);
    }

    public function update_user_preferences() {
        parent::update_user_preferences();

        if (quizinvideo_has_grades($this->quizinvideo)) {
            set_user_preference('quizinvideo_overview_slotmarks', $this->slotmarks);
        }
    }
    ...
    public function resolve_dependencies() {
        ...
        $this->checkboxcolumn = has_any_capability(
                array('mod/quizinvideo:regrade', 'mod/quizinvideo:deleteattempts'), context_module::instance($this->cm->id))
