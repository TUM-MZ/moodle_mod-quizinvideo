...
class quizinvideo_attempt {
     ...
     * or someone with 'mod/quizinvideo:viewreports' reviewing someone elses attempt.
     *
    ...
    /**
     * Return the list of question ids for either a given page of the quizinvideo, or for the
     * whole quizinvideo.
     *
