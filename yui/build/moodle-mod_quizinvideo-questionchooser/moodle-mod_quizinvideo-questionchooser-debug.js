YUI.add('moodle-mod_quizinvideo-questionchooser', function (Y, NAME) {
...
Y.extend(QUESTIONCHOOSER, M.core.chooserdialogue, {
    ...
    NAME: 'mod_quizinvideo-questionchooser'
});

M.mod_quizinvideo = M.mod_quizinvideo || {};
M.mod_quizinvideo.init_questionchooser = function() {
    M.mod_quizinvideo.question_chooser = new QUESTIONCHOOSER({});
    return M.mod_quizinvideo.question_chooser;
};


}, '@VERSION@', {"requires": ["moodle-core-chooserdialogue", "moodle-mod_quizinvideo-util", "querystring-parse"]});
