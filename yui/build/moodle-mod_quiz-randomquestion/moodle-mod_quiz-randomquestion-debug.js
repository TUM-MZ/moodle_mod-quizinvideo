YUI.add('moodle-mod_quizinvideo-randomquestion', function (Y, NAME) {
...
/**
 * Add a random question functionality for a popup in quizinvideo editing page.
 *
...
M.mod_quizinvideo.randomquestion = M.mod_quizinvideo.randomquestion || {};
M.mod_quizinvideo.randomquestion.init = function() {
    return new POPUP();
};
