YUI.add('moodle-mod_quizinvideo-dragdrop', function (Y, NAME) {

/**
 * Drag and Drop for quizinvideo sections and slots.
 *
 * @module moodle-mod-quizinvideo-dragdrop
 */
...
var CSS = {
    ...
    CONTENT: 'content',
    COURSECONTENT: 'mod-quizinvideo-edit-content',
 ...
 *
 * @class M.mod_quizinvideo.dragdrop.section
 * @constructor
...
Y.extend(DRAGSECTION, M.core.dragdrop, {
    ...
    initializer: function() {
        ...
        this.samenodeclass = M.mod_quizinvideo.edit.get_sectionwrapperclass();
        this.parentnodeclass = M.mod_quizinvideo.edit.get_containerclass();
        ...
        this.sectionlistselector = M.mod_quizinvideo.edit.get_section_wrapper(Y);
        if (this.sectionlistselector) {
            ...
            del.dd.plug(Y.Plugin.DDConstrained, {
                // Keep it inside the .mod-quizinvideo-edit-content
    ...
    drag_start: function(e) {
        ...
        var containernode = Y.Node.create('<' + M.mod_quizinvideo.edit.get_containernode() + '></' + M.mod_quizinvideo.edit.get_containernode() + '>');
        containernode.addClass(M.mod_quizinvideo.edit.get_containerclass());
        var sectionnode = Y.Node.create('<' + M.mod_quizinvideo.edit.get_sectionwrappernode() + '></' + M.mod_quizinvideo.edit.get_sectionwrappernode() + '>');
        sectionnode.addClass( M.mod_quizinvideo.edit.get_sectionwrapperclass());
    ...
    get_section_index: function(node) {
        var sectionlistselector = '.' + CSS.COURSECONTENT + ' ' + M.mod_quizinvideo.edit.get_section_selector(Y),
    ...
    drop_hit: function(e) {
        ...
        if (dragnodeid === dropnodeindex) {
            Y.log("Skipping move - same location moving " + dragnodeid + " to " + dropnodeindex, 'debug', 'moodle-mod_quizinvideo-dragdrop');
            return;
        }

        Y.log("Moving from position " + dragnodeid + " to position " + dropnodeindex, 'debug', 'moodle-mod_quizinvideo-dragdrop');
        ...
        params.quizinvideoid = this.get('quizinvideoid');
            ...
            on: {
                ...
                success: function(tid, response) {
                    ...
                    try {
                        ...
                        M.mod_quizinvideo.edit.process_sections(Y, sectionlist, responsetext, loopstart, loopend);
                    } catch (e) {}
                        ...
                        for (index = loopstart; index <= loopend; index++) {
                            if (Y.Moodle.core_course.util.section.getId(sectionlist.item(index - 1)) >
                                ...
                                Y.log("Swapping " + Y.Moodle.core_course.util.section.getId(sectionlist.item(index - 1)) +
                                        ...
                                        "debug", "moodle-mod_quizinvideo-dragdrop");
                                // Swap section id.
                                ...
                                M.mod_quizinvideo.edit.swap_sections(Y, index - 1, index);
    ...
    NAME: 'mod_quizinvideo-dragdrop-section',
    ATTRS: {
        courseid: {
            value: null
        },
...
M.mod_quizinvideo.init_section_dragdrop = function(params) {
...
Y.extend(DRAGRESOURCE, M.core.dragdrop, {
    initializer: function() {
        ...
        var sectionlistselector = M.mod_quizinvideo.edit.get_section_selector(Y);
        if (sectionlistselector) {
            ...
            M.mod_quizinvideo.dragres = this;
        }
    },
    ...
    drop_hit: function(e) {
        ...
        params.field = 'move';
        params.id = Number(Y.Moodle.mod_quizinvideo.util.slot.getId(dragnode));
        params.sectionId = Y.Moodle.core_course.util.section.getId(dropnode.ancestor(M.mod_quizinvideo.edit.get_section_wrapper(Y), true));

        var previousslot = dragnode.previous(SELECTOR.SLOT);
        if (previousslot) {
            params.previousid = Number(Y.Moodle.mod_quizinvideo.util.slot.getId(previousslot));
        }

        var previouspage = dragnode.previous(SELECTOR.PAGE);
        if (previouspage) {
            params.page = Number(Y.Moodle.mod_quizinvideo.util.page.getId(previouspage));
        }
        ...
        Y.io(uri, {
            ...
            on: {
                ...
                success: function(tid, response) {
                    ...
                    M.mod_quizinvideo.quizinvideobase.invoke_function('set_visibility_resource_ui', params);
                    this.unlock_drag_handle(drag, CSS.EDITINGMOVE);
                    window.setTimeout(function() {
                        spinner.hide();
                    }, 250);
                    M.mod_quizinvideo.resource_toolbox.reorganise_edit_page();
                },
                failure: function(tid, response) {
                    this.ajax_failure(response);
    ...
    NAME: 'mod_quizinvideo-dragdrop-resource',
    ATTRS: {
        courseid: {
            value: null
        },
...
M.mod_quizinvideo = M.mod_quizinvideo || {};
M.mod_quizinvideo.init_resource_dragdrop = function(params) {
    ...
    "requires": [
        ...
        "moodle-mod_quizinvideo-quizinvideobase",
        "moodle-mod_quizinvideo-util-base",
        "moodle-mod_quizinvideo-util-page",
        "moodle-mod_quizinvideo-util-slot",
        "moodle-course-util"
    ]
});
