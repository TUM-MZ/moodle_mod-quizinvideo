YUI.add('moodle-mod_quizinvideo-quizinvideobase', function (Y, NAME) {

/**
 * The quizinvideobase class to provide shared functionality to Modules within Moodle.
 *
 * @module moodle-mod_quizinvideo-quizinvideobase
 */
var quizinvideoBASENAME = 'mod_quizinvideo-quizinvideobase';

var quizinvideoBASE = function() {
    quizinvideoBASE.superclass.constructor.apply(this, arguments);
};
 ...
 * @constructor
 */
Y.extend(quizinvideoBASE, Y.Base, {
    // Registered Modules
    registermodules : [],
 ...
 */
M.mod_quizinvideo.edit.swap_sections = function(Y, node1, node2) {
    var CSS = {
        COURSECONTENT : 'mod-quizinvideo-edit-content',
        SECTIONADDMENUS : 'section_add_menus'
    };

    var sectionlist = Y.Node.all('.' + CSS.COURSECONTENT + ' ' + M.mod_quizinvideo.edit.get_section_selector(Y));
    // Swap menus.
 ...
 * @return void
 */
M.mod_quizinvideo.edit.process_sections = function(Y, sectionlist, response, sectionfrom, sectionto) {
    var CSS = {
...
*/
M.mod_quizinvideo.edit.get_config = function() {
    return {
        container_node : 'ul',
 ...
 */
M.mod_quizinvideo.edit.get_section_selector = function() {
    var config = M.mod_quizinvideo.edit.get_config();
    if (config.section_node && config.section_class) {
        return config.section_node + '.' + config.section_class;
    }
    Y.log('section_node and section_class are not defined in M.mod_quizinvideo.edit.get_config', 'warn', 'moodle-mod_quizinvideo-quizinvideobase');
    return null;
};
 ...
 *
 * @param {YUI} Y YUI3 instance
 * @return {string} section wrapper selector or M.mod_quizinvideo.format.get_section_selector
 * if section_wrapper_node and section_wrapper_class are not defined in the format config.
 */
M.mod_quizinvideo.edit.get_section_wrapper = function(Y) {
    var config = M.mod_quizinvideo.edit.get_config();
    ...
    return M.mod_quizinvideo.edit.get_section_selector(Y);
};
 ...
 */
M.mod_quizinvideo.edit.get_containernode = function() {
    var config = M.mod_quizinvideo.edit.get_config();
    if (config.container_node) {
        return config.container_node;
    } else {
        Y.log('container_node is not defined in M.mod_quizinvideo.edit.get_config', 'warn', 'moodle-mod_quizinvideo-quizinvideobase');
    }
};
 ...
 */
M.mod_quizinvideo.edit.get_containerclass = function() {
    var config = M.mod_quizinvideo.edit.get_config();
    if (config.container_class) {
        return config.container_class;
    } else {
        Y.log('container_class is not defined in M.mod_quizinvideo.edit.get_config', 'warn', 'moodle-mod_quizinvideo-quizinvideobase');
    }
};
 ...
 */
M.mod_quizinvideo.edit.get_sectionwrappernode = function() {
    var config = M.mod_quizinvideo.edit.get_config();
 ...
 */
M.mod_quizinvideo.edit.get_sectionwrapperclass = function() {
    var config = M.mod_quizinvideo.edit.get_config();
 ...
 */
M.mod_quizinvideo.edit.get_sectionnode = function() {
    var config = M.mod_quizinvideo.edit.get_config();
    if (config.section_node) {
        return config.section_node;
    } else {
        Y.log('section_node is not defined in M.mod_quizinvideo.edit.get_config', 'warn', 'moodle-mod_quizinvideo-quizinvideobase');
    }
};
 ...
 */
M.mod_quizinvideo.edit.get_sectionclass = function() {
    var config = M.mod_quizinvideo.edit.get_config();
    if (config.section_class) {
        return config.section_class;
    } else {
        Y.log('section_class is not defined in M.mod_quizinvideo.edit.get_config', 'warn', 'moodle-mod_quizinvideo-quizinvideobase');
    }
};
