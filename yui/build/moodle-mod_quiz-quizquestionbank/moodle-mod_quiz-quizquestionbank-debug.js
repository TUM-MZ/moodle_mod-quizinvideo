YUI.add('moodle-mod_quizinvideo-quizinvideoquestionbank', function (Y, NAME) {
...
/**
 * Add questions from question bank functionality for a popup in quizinvideo editing page.
 *
...
var CSS = {
        ...
        ADDTOquizinvideoCONTAINER: 'td.addtoquizinvideoaction',
...
Y.extend(POPUP, Y.Base, {
    ...
    create_dialogue: function() {
        ...
        var config = {
            ...
            postmethod: 'form',
            footerContent: null,
            extraClasses: ['mod_quizinvideo_qbank_dialogue']
        };
    ...
    load_content : function(queryString) {
        Y.log('Starting load.', 'debug', 'moodle-mod_quizinvideo-quizinvideoquestionbank');
        this.dialogue.bodyNode.append(this.loadingDiv);

        // If to support old IE.
        if (window.history.replaceState) {
            window.history.replaceState(null, '', M.cfg.wwwroot + '/mod/quizinvideo/edit.php' + queryString);
        }

        Y.io(M.cfg.wwwroot + '/mod/quizinvideo/questionbank.ajax.php' + queryString, {
            method: 'GET',
            on: {
        ...
        Y.log('Load request sent.', 'debug', 'moodle-mod_quizinvideo-quizinvideoquestionbank');
    },
    ...
    load_done: function(transactionid, response) {
        ...
        Y.log('Load completed.', 'debug', 'moodle-mod_quizinvideo-quizinvideoquestionbank');
    ...
    load_failed: function() {
        Y.log('Load failed.', 'debug', 'moodle-mod_quizinvideo-quizinvideoquestionbank');
    },

    link_clicked: function(e) {
        // Add question to quizinvideo. mofify the URL, then let it work as normal.
        if (e.currentTarget.ancestor(CSS.ADDTOquizinvideoCONTAINER)) {
...
M.mod_quizinvideo.quizinvideoquestionbank = M.mod_quizinvideo.quizinvideoquestionbank || {};
M.mod_quizinvideo.quizinvideoquestionbank.init = function() {
    return new POPUP();
};
