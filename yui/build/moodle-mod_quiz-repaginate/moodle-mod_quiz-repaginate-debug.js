YUI.add('moodle-mod_quizinvideo-repaginate', function (Y, NAME) {
...
/**
 * Repaginate functionality for a popup in quizinvideo editing page.
 *
...
M.mod_quizinvideo.repaginate = M.mod_quizinvideo.repaginate || {};
M.mod_quizinvideo.repaginate.init = function() {
    return new POPUP();
};
