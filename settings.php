...
if ($ADMIN->fulltree) {
    ...
    // Time limit.
    $quizinvideosettings->add(new admin_setting_configtext_with_advanced('quizinvideo/timelimit',
            get_string('timelimitsec', 'quizinvideo'), get_string('configtimelimitsec', 'quizinvideo'),
    ...
    // Grace period time.
    $quizinvideosettings->add(new admin_setting_configtext_with_advanced('quizinvideo/graceperiod',
    ...
    $quizinvideosettings->add(new admin_setting_configtext('quizinvideo/graceperiodmin',
    ...
    // Shuffle questions.
    $quizinvideosettings->add(new admin_setting_configcheckbox_with_advanced('quizinvideo/shufflequestions',
            get_string('shufflequestions', 'quizinvideo'), get_string('configshufflequestions', 'quizinvideo'),
    ...
    $quizinvideosettings->add(new admin_setting_configtext_with_advanced('quizinvideo/delay1',
            get_string('delay1st2nd', 'quizinvideo'), get_string('configdelay1st2nd', 'quizinvideo'),
            array('value' => 0, 'adv' => true), PARAM_INT));
    $quizinvideosettings->add(new admin_setting_configtext_with_advanced('quizinvideo/delay2',
    ...
    // Autosave frequency.
    $options = array(
          0 => get_string('donotuseautosave', 'quizinvideo'),
         60 => get_string('oneminute', 'quizinvideo'),
        120 => get_string('numminutes', 'moodle', 2),
        300 => get_string('numminutes', 'moodle', 5),
    );
    $quizinvideosettings->add(new admin_setting_configselect('quizinvideo/autosaveperiod',
            get_string('autosaveperiod', 'quizinvideo'), get_string('autosaveperiod_desc', 'quizinvideo'), 120, $options));
}
