...
M.mod_quizinvideo.timer = {
    ...
    update: function() {
        ...
        if (secondsleft < 0) {
            ...
            Y.one('#quizinvideo-time-left').setContent(M.str.quizinvideo.timesup);
...
M.mod_quizinvideo.secure_window = {
    init: function(Y) {
        ...
        M.mod_quizinvideo.secure_window.clear_status;
    ...
    clear_status: function() {
        window.status = '';
        setTimeout(M.mod_quizinvideo.secure_window.clear_status, 10);
    },
    ...
    prevent: function(e) {
        alert(M.str.quizinvideo.functiondisabledbysecuremode);
        e.halt();
    },
