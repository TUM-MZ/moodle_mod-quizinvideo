...
/**
 * Strings for component 'quizinvideo', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['accessnoticesheader'] = 'You can preview this quizinvideo, but if this were a real attempt, you would be blocked because:';
$string['action'] = 'Action';
$string['activityoverview'] = 'You have quizinvideos that are due';
$string['adaptive'] = 'Adaptive mode';
$string['adaptive_help'] = 'If enabled, multiple responses to a question are allowed within the same attempt at the quizinvideo. So for example if a response is marked as incorrect, the student will be allowed to try again immediately. However, depending on the "Apply penalties" setting, a penalty will usually be subtracted for each wrong attempt.';
$string['add'] = 'Add';
$string['addaquestion'] = 'a new question';
$string['addarandomquestion'] = 'a random question';
$string['addarandomquestion_help'] = 'When a random question is added, it results in a randomly-chosen question from the category being inserted into the quizinvideo. This means that different students are likely to get a different selection of questions, and when a quizinvideo allows multiple attempts then each attempt is likely to contain a new selection of questions.';
...
$string['addingquestions'] = '<p>This side of the page is where you manage your database of questions. Questions are stored in categories to help you keep them organised, and can be used by any quizinvideo in your course or even other courses if you choose to \'publish\' them.</p>
<p>After you select or create a question category you will be able to create or edit questions. You can select any of these questions to add to your quizinvideo over on the other side of this page.</p>';
...
$string['addquestionstoquizinvideo'] = 'Add questions to current quizinvideo';
...
$string['addrandomquestiontoquizinvideo'] = 'Add a random question to quizinvideo {$a}';
$string['addrandom1'] = '<< Add';
$string['addrandom2'] = 'random questions';
$string['addselectedquestionstoquizinvideo'] = 'Add selected questions to the quizinvideo';
$string['addselectedtoquizinvideo'] = 'Add selected to quizinvideo';
$string['addtoquizinvideo'] = 'Add to quizinvideo';
...
$string['attempterror'] = 'You are not allowed to attempt this quizinvideo at this time because: {$a}';
$string['attemptfirst'] = 'First attempt';
$string['attemptincomplete'] = 'That attempt (by {$a}) is not yet completed.';
$string['attemptlast'] = 'Last attempt';
$string['attemptnumber'] = 'Attempt';
$string['attemptquizinvideonow'] = 'Attempt quizinvideo now';
$string['attempts'] = 'Attempts';
$string['attemptsallowed'] = 'Attempts allowed';
$string['attemptsdeleted'] = 'Quizinvideo attempts deleted';
...
$string['autosaveperiod_desc'] = 'Students\' responses can be saved automatically every few minutes during quizinvideo attempts. This involves a trade-off: saving the responses increases the server load, but reduces the chance that students lose their work.';
$string['back'] = 'Back to preview question';
$string['backtocourse'] = 'Back to the course';
$string['backtoquestionlist'] = 'Back to question list';
$string['backtoquizinvideo'] = 'Back to quizinvideo editing';
$string['basicideasofquizinvideo'] = 'The basic ideas of quizinvideo-making';
...
* The quizinvideo will only start if the student has a JavaScript-enabled web-browser
* The quizinvideo appears in a full screen popup window that covers all the other windows and has no navigation controls
...
$string['cannoteditafterattempts'] = 'You cannot add or remove questions because this quizinvideo has been attempted. ({$a})';
...
$string['cannotsetgrade'] = 'Could not set a new maximum grade for the quizinvideo';
$string['cannotsetsumgrades'] = 'Failed to set sumgrades';
$string['cannotstartgradesmismatch'] = 'Cannot start an attempt at this quizinvideo. The quizinvideo is set to be graded out of {$a->grade}, but none of the questions in the quizinvideo have a grade. This can be fixed on the \'Edit quizinvideo\' page.';
$string['cannotstartmissingquestion'] = 'Cannot start an attempt at this quizinvideo. The quizinvideo definition includes a question that does not exist.';
$string['cannotstartnoquestions'] = 'Cannot start an attempt at this quizinvideo. The quizinvideo has not been set up yet. No questions have been added.';
...
$string['closebeforeopen'] = 'Could not update the quizinvideo. You have specified a close date before the open date.';
...
$string['completionattemptsexhausted_help'] = 'Mark quizinvideo complete when the student has exhausted the maximum number of attempts.';
$string['configadaptive'] = 'If you choose Yes for this option then the student will be allowed multiple responses to a question even within the same attempt at the quizinvideo.';
$string['configattemptsallowed'] = 'Restriction on the number of attempts students are allowed at the quizinvideo.';
$string['configdecimaldigits'] = 'Number of digits that should be shown after the decimal point when displaying grades.';
$string['configdecimalplaces'] = 'Number of digits that should be shown after the decimal point when displaying grades for the quizinvideo.';
...
$string['configdelay1'] = 'If you set a time delay, then a student has to wait for that time before they can attempt a quizinvideo after the first attempt.';
...
$string['configgrademethod'] = 'When multiple attempts are allowed, which method should be used to calculate the student\'s final grade for the quizinvideo.';
$string['configintro'] = 'The values you set here define the default values that are used in the settings form when you create a new quizinvideo. You can also configure which quizinvideo settings are considered advanced.';
$string['configmaximumgrade'] = 'The default grade that the quizinvideo grade is scaled to be out of.';
$string['confignewpageevery'] = 'When adding questions to the quizinvideo page breaks will automatically be inserted according to the setting you choose here.';
...
$string['configoutcomesadvanced'] = 'If this option is turned on, then the Outcomes on the quizinvideo editing form are advanced settings.';
$string['configpenaltyscheme'] = 'Penalty subtracted for each wrong response in adaptive mode.';
$string['configpopup'] = 'Force the attempt to open in a popup window, and use JavaScript tricks to try to restrict copy and paste, etc. during quizinvideo attempts.';
$string['configrequirepassword'] = 'Students must enter this password before they can attempt the quizinvideo.';
$string['configrequiresubnet'] = 'Students can only attempt the quizinvideo from these computers.';
$string['configreviewoptions'] = 'These options control what information users can see when they review a quizinvideo attempt or look at the quizinvideo reports.';
$string['configshowblocks'] = 'Show blocks during quizinvideo attempts.';
$string['configshowuserpicture'] = 'Show the user\'s picture on screen during attempts.';
$string['configshufflequestions'] = 'If you enable this option, then the order of questions in  the quizinvideo will be randomly shuffled each time a student attempts the quizinvideo.';
$string['configshufflewithin'] = 'If you enable this option, then the parts making up the individual questions will be randomly shuffled each time a student starts an attempt at this quizinvideo, provided the option is also enabled in the question settings.';
$string['configtimelimit'] = 'Default time limit for quizinvideos in minutes. 0 mean no time limit.';
$string['configtimelimitsec'] = 'Default time limit for quizinvideos in seconds. 0 mean no time limit.';
...
$string['confirmstartattempttimelimit'] = 'This quizinvideo has a time limit and is limited to {$a} attempt(s). You are about to start a new attempt.  Do you wish to proceed?';
$string['confirmstarttimelimit'] = 'The quizinvideo has a time limit. Are you sure that you wish to start?';
...
$string['continueattemptquizinvideo'] = 'Continue the last attempt';
...
$string['countdownfinished'] = 'The quizinvideo is closing, you should submit your answers now.';
$string['countdowntenminutes'] = 'The quizinvideo will be closing in ten minutes.';
...
$string['createmultiple'] = 'Add several random questions to quizinvideo';
$string['createnewquestion'] = 'Create new question';
$string['createquestionandadd'] = 'Create a new question and add it to the quizinvideo.';
...
$string['delaylater_help'] = 'If enabled, a student must wait for the specified time to elapse before attempting the quizinvideo a third time and any subsequent times.';
$string['delay1'] = 'Time delay between first and second attempt';
$string['delay1st2nd'] = 'Enforced delay between 1st and 2nd attempts';
$string['delay1st2nd_help'] = 'If enabled, a student must wait for the specified time to elapse before being able to attempt the quizinvideo a second time.';
...
$string['downloadextra'] = '(file is also stored in the course files in the /backupdata/quizinvideo folder)';
...
$string['eachattemptbuildsonthelast_help'] = 'If multiple attempts are allowed and this setting is enabled, each new quizinvideo attempt will contain the results of the previous attempt. This allows a quizinvideo to be completed over several attempts.';
$string['editcategories'] = 'Edit categories';
$string['editcategory'] = 'Edit category';
$string['editcatquestions'] = 'Edit category questions';
$string['editingquestion'] = 'Editing a question';
$string['editingquizinvideo'] = 'Editing quizinvideo';
$string['editingquizinvideo_help'] = 'When creating a quizinvideo, the main concepts are:

* The quizinvideo, containing questions over one or more pages
* The question bank, which stores copies of all questions organised into categories
* Random questions -  A student gets different questions each time they attempt the quizinvideo and different students can get different questions';
$string['editingquizinvideo_link'] = 'mod/quizinvideo/edit';
$string['editingquizinvideox'] = 'Editing quizinvideo: {$a}';
...
$string['editquizinvideo'] = 'Edit quizinvideo';
$string['editquizinvideoquestions'] = 'Edit quizinvideo questions';
...
You can access this quizinvideo at {$a->quizinvideourl}.';
$string['emailconfirmsmall'] = 'Thank you for submitting your answers to \'{$a->quizinvideoname}\'';
$string['emailconfirmsubject'] = 'Submission confirmation: {$a->quizinvideoname}';
...
You can review this attempt at {$a->quizinvideoreviewurl}.';
$string['emailnotifysmall'] = '{$a->studentname} has completed {$a->quizinvideoname}. See {$a->quizinvideoreviewurl}';
$string['emailnotifysubject'] = '{$a->studentname} has completed {$a->quizinvideoname}';
$string['emailoverduebody'] = 'Dear {$a->studentname},

You started an attempt at \'{$a->quizinvideoname}\'
...
$string['emailoverduesmall'] = 'You did not submit your attempt at {$a->quizinvideoname}. Please go to {$a->attemptsummaryurl} before {$a->attemptgraceend} if you would still like to submit.';
$string['emailoverduesubject'] = 'Attempt now overdue: {$a->quizinvideoname}';
$string['empty'] = 'Empty';
...
$string['eventattemptdeleted'] = 'Quizinvideo attempt deleted';
$string['eventattemptpreviewstarted'] = 'Quizinvideo attempt preview started';
$string['eventattemptreviewed'] = 'Quizinvideo attempt reviewed';
$string['eventattemptsummaryviewed'] = 'Quizinvideo attempt summary viewed';
$string['eventattemptviewed'] = 'Quizinvideo attempt viewed';
$string['eventeditpageviewed'] = 'Quizinvideo edit page viewed';
$string['eventoverridecreated'] = 'Quizinvideo override created';
$string['eventoverridedeleted'] = 'Quizinvideo override deleted';
$string['eventoverrideupdated'] = 'Quizinvideo override updated';
$string['eventquestionmanuallygraded'] = 'Question manually graded';
$string['eventquizinvideoattemptabandoned'] = 'Quizinvideo attempt abandoned';
$string['eventquizinvideoattempttimelimitexceeded'] = 'Quizinvideo attempt time limit exceeded';
$string['eventquizinvideoattemptstarted'] = 'Quizinvideo attempt started';
$string['eventquizinvideoattemptsubmitted'] = 'Quizinvideo attempt submitted';
$string['eventreportviewed'] = 'Quizinvideo report viewed';
...
$string['graceperiodmin_desc'] = 'There is a potential problem right at the end of the quizinvideo. On the one hand, we want to let students continue working right up until the last second - with the help of the timer that automatically submits the quizinvideo when time runs out. On the other hand, the server may then be overloaded, and take some time to get to process the responses. Therefore, we will accept responses for up to this many seconds after time expires, so they are not penalised for the server being slow. However, the student could cheat and get this many seconds to answer the quizinvideo. You have to make a trade-off based on how much you trust the performance of your server during quizinvideos.';
...
$string['grademethod_help'] = 'When multiple attempts are allowed, the following methods are available for calculating the final quizinvideo grade:

* Highest grade of all attempts
* Average (mean) grade of all attempts
* First attempt (all other attempts are ignored)
* Last attempt (all other attempts are ignored)';
$string['gradesdeleted'] = 'Quizinvideo grades deleted';
...
$string['guestsno'] = 'Sorry, guests cannot see or attempt quizinvideos';
$string['hidebreaks'] = 'Hide page breaks';
$string['hidereordertool'] = 'Hide the reordering tool';
$string['history'] = 'History of responses:';
$string['howquestionsbehave_desc'] = 'Default setting for how questions behave in a quizinvideo.';
...
$string['inactiveoverridehelp'] = '* Student does not have the correct group or role to attempt the quizinvideo';
...
$string['invalidquizinvideoid'] = 'Invalid quizinvideo ID';
...
$string['link'] = 'Link';
$string['listitems'] = 'Listing of items in quizinvideo';
...
$string['messageprovider:attempt_overdue'] = 'Warning when your quizinvideo attempt becomes overdue';
$string['messageprovider:confirmation'] = 'Confirmation of your own quizinvideo submissions';
$string['messageprovider:submission'] = 'Notification of quizinvideo submissions';
$string['max'] = 'Max';
...
$string['modulename'] = 'Quizinvideo';
$string['modulename_help'] = 'The quizinvideo activity enables a teacher to create quizinvideos comprising questions of various types, including multiple choice, matching, short-answer and numerical.

The teacher can allow the quizinvideo to be attempted multiple times, with the questions shuffled or randomly selected from the question bank. A time limit may be set.
...
$string['modulenameplural'] = 'Quizinvideos';
...
$string['navmethod_help'] = 'When sequential navigation is enabled a student must progress through the quizinvideo in order and may not return to previous pages nor skip ahead.';
...
$string['newattemptfail'] = 'Error: Could not start a new attempt at the quizinvideo';
$string['newpage'] = 'New page';
$string['newpage_help'] = 'For longer quizinvideos it makes sense to stretch the quizinvideo over several pages by limiting the number of questions per page. When adding questions to the quizinvideo, page breaks will automatically be inserted according to this setting. However page breaks may later be moved manually on the editing page.';
$string['newpageevery'] = 'Automatically start a new page';
$string['noanswers'] = 'No answers were selected!';
$string['noattempts'] = 'No attempts have been made on this quizinvideo';
...
$string['nogradewarning'] = 'This quizinvideo is not graded, so you cannot set overall feedback that differs by grade.';
$string['nomoreattempts'] = 'No more attempts are allowed';
$string['none'] = 'None';
$string['noopen'] = 'No open date';
$string['nooverridedata'] = 'You must override at least one of the quizinvideo settings.';
...
$string['noquestionsinquizinvideo'] = 'There are no questions in this quizinvideo.';
...
$string['noreview'] = 'You are not allowed to review this quizinvideo';
$string['noreviewattempt'] = 'You are not allowed to review this attempt.';
$string['noreviewshort'] = 'Not permitted';
$string['noreviewuntil'] = 'You are not allowed to review this quizinvideo until {$a}';
$string['noreviewuntilshort'] = 'Available {$a}';
$string['noscript'] = 'JavaScript must be enabled to continue!';
$string['notavailabletostudents'] = 'Note: This quizinvideo is not currently available to your students';
...
$string['notimedependentitems'] = 'Time dependent items are not currently supported by the quizinvideo module. As a work around, set a time limit for the whole quizinvideo. Do you wish to choose a different item (or use the current item regardless)?';
$string['notyetgraded'] = 'Not yet graded';
$string['notyetviewed'] = 'Not yet viewed';
$string['notyourattempt'] = 'This is not your attempt!';
$string['noview'] = 'Logged-in user is not allowed to view this quizinvideo';
$string['numattempts'] = '{$a->studentnum} {$a->studentstring} have made {$a->attemptnum} attempts';
$string['numattemptsmade'] = '{$a} attempts made on this quizinvideo';
$string['numberabbr'] = '#';
...
$string['openclosedatesupdated'] = 'Quizinvideo open and close dates updated';
...
$string['orderingquizinvideo'] = 'Order and paging';
$string['orderingquizinvideox'] = 'Order and paging: {$a}';
...
$string['overallfeedback_help'] = 'Overall feedback is text that is shown after a quizinvideo has been attempted. By specifying additional grade boundaries (as a percentage or as a number), the text shown can depend on the grade obtained.';
$string['overdue'] = 'Overdue';
$string['overduehandling'] = 'When time expires';
$string['overduehandling_desc'] = 'What should happen by default if a student does not submit the quizinvideo before time expires.';
$string['overduehandling_help'] = 'This setting controls what happens if the Student fails to submit their quizinvideo attempt before time expires. If the student is actively working on the quizinvideo at the time, then the countdown timer will always automatically submit the attempt for them, but if they have logged out, then this setting controls what happens.';
...
$string['overduemustbesubmittedby'] = 'This attempt is now overdue. It should already have been submitted. If you would like this quizinvideo to be graded, you must submit it by {$a}. If you do not submit it by then, no marks from this attempt will be counted.';
...
$string['overrideusereventname'] = '{$a->quizinvideo} - Override';
$string['pageshort'] = 'P';
$string['page-mod-quizinvideo-x'] = 'Any quizinvideo module page';
$string['page-mod-quizinvideo-attempt'] = 'Attempt quizinvideo page';
$string['page-mod-quizinvideo-edit'] = 'Edit quizinvideo page';
$string['page-mod-quizinvideo-report'] = 'Any quizinvideo report page';
$string['page-mod-quizinvideo-review'] = 'Review quizinvideo attempt page';
$string['page-mod-quizinvideo-summary'] = 'Quizinvideo attempt summary page';
$string['page-mod-quizinvideo-view'] = 'Quizinvideo information page';
...
$string['pluginadministration'] = 'Quizinvideo administration';
$string['pluginname'] = 'Quizinvideo';
$string['popup'] = 'Show quizinvideo in a &quot;secure&quot; window';
$string['popupblockerwarning'] = 'This section of the test is in secure mode, this means that you need to take the quizinvideo in a secure window. Please turn off your popup blocker. Thank you.';
$string['popupnotice'] = 'Students will see this quizinvideo in a secure window';
$string['preprocesserror'] = 'Error occurred during pre-processing!';
$string['preview'] = 'Preview';
$string['previewquestion'] = 'Preview question';
$string['previewquizinvideo'] = 'Preview {$a}';
$string['previewquizinvideonow'] = 'Preview quizinvideo now';
...
$string['questioninuse'] = 'The question \'{$a->questionname}\' is currently being used in: <br />{$a->quizinvideonames}<br />The question will not be deleted from these quizinvideos but only from the category list.';
...
$string['questionsinthisquizinvideo'] = 'Questions in this quizinvideo';
...
$string['quizinvideo:addinstance'] = 'Add a new quizinvideo';
$string['quizinvideo:attempt'] = 'Attempt quizinvideos';
$string['quizinvideoavailable'] = 'The quizinvideo is available until: {$a}';
$string['quizinvideoclose'] = 'Close the quizinvideo';
$string['quizinvideoclosed'] = 'This quizinvideo closed on {$a}';
$string['quizinvideocloses'] = 'Quizinvideo closes';
$string['quizinvideocloseson'] = 'This quizinvideo will close at {$a}';
$string['quizinvideo:deleteattempts'] = 'Delete quizinvideo attempts';
$string['quizinvideo:emailconfirmsubmission'] = 'Get a confirmation message when submitting';
$string['quizinvideo:emailnotifysubmission'] = 'Get a notification message when an attempt is submitted';
$string['quizinvideo:emailwarnoverdue'] = 'Get a notification message when an attempt becomes overdue and needs to be submitted.';
$string['quizinvideo:grade'] = 'Grade quizinvideos manually';
$string['quizinvideo:ignoretimelimits'] = 'Ignores time limit on quizinvideos';
$string['quizinvideoisclosed'] = 'This quizinvideo is closed';
$string['quizinvideoisopen'] = 'This quizinvideo is open';
$string['quizinvideoisclosedwillopen'] = 'Quizinvideo closed (opens {$a})';
$string['quizinvideoisopenwillclose'] = 'Quizinvideo open (closes {$a})';
$string['quizinvideo:manage'] = 'Manage quizinvideos';
$string['quizinvideo:manageoverrides'] = 'Manage quizinvideo overrides';
$string['quizinvideonavigation'] = 'Quizinvideo navigation';
$string['quizinvideoopen'] = 'Open the quizinvideo';
$string['quizinvideoopenclose'] = 'Open and close dates';
$string['quizinvideoopenclose_help'] = 'Students can only start their attempt(s) after the open time and they must complete their attempts before the close time.';
$string['quizinvideoopenclose_link'] = 'mod/quizinvideo/timing';
$string['quizinvideoopened'] = 'This quizinvideo is open.';
$string['quizinvideoopenedon'] = 'This quizinvideo opened at {$a}';
$string['quizinvideoopens'] = 'Quizinvideo opens';
$string['quizinvideoopenwillclose'] = 'This quizinvideo is open, will close on {$a} at';
$string['quizinvideoordernotrandom'] = 'Order of quizinvideo not shuffled';
$string['quizinvideoorderrandom'] = '* Order of quizinvideo is shuffled';
$string['quizinvideo:preview'] = 'Preview quizinvideos';
$string['quizinvideo:regrade'] = 'Regrade quizinvideo attempts';
$string['quizinvideo:reviewmyattempts'] = 'Review your own attempts';
$string['quizinvideosettings'] = 'Quizinvideo settings';
$string['quizinvideo:view'] = 'View quizinvideo information';
$string['quizinvideo:viewreports'] = 'View quizinvideo reports';
$string['quizinvideotimer'] = 'Quizinvideo Timer';
$string['quizinvideowillopen'] = 'This quizinvideo will open {$a}';
...
$string['readytosend'] = 'You are about to send your whole quizinvideo to be graded.  Are you sure you want to continue?';
$string['reattemptquizinvideo'] = 'Re-attempt quizinvideo';
...
$string['regradenotallowed'] = 'You do not have permission to regrade this quizinvideo';
$string['regradingquestion'] = 'Regrading "{$a}".';
$string['regradingquizinvideo'] = 'Regrading quizinvideo "{$a}"';
$string['remove'] = 'Remove';
$string['removeallquizinvideoattempts'] = 'Delete all quizinvideo attempts';
...
$string['reportusersall'] = 'all users who have attempted the quizinvideo';
$string['reportuserswith'] = 'enrolled users who have attempted the quizinvideo';
$string['reportuserswithorwithout'] = 'enrolled users who have, or have not, attempted the quizinvideo';
$string['reportuserswithout'] = 'enrolled users who have not attempted the quizinvideo';
$string['reportwhattoinclude'] = 'What to include in the report';
$string['requirepassword'] = 'Require password';
$string['requirepassword_help'] = 'If a password is specified, a student must enter it in order to attempt the quizinvideo.';
$string['requiresubnet'] = 'Require network address';
$string['requiresubnet_help'] = 'Quizinvideo access may be restricted to particular subnets on the LAN or Internet by specifying a comma-separated list of partial or full IP address numbers. This can be useful for an invigilated (proctored) quizinvideo, to ensure that only people in a certain location can access the quizinvideo.';
$string['response'] = 'Response';
$string['responses'] = 'Responses';
$string['results'] = 'Results';
$string['returnattempt'] = 'Return to attempt';
$string['reuseifpossible'] = 'reuse previously removed';
$string['reverttodefaults'] = 'Revert to quizinvideo defaults';
$string['review'] = 'Review';
$string['reviewafter'] = 'Allow review after quizinvideo is closed';
$string['reviewalways'] = 'Allow review at any time';
$string['reviewattempt'] = 'Review attempt';
$string['reviewbefore'] = 'Allow review while quizinvideo is open';
$string['reviewclosed'] = 'After the quizinvideo is closed';
...
$string['reviewopen'] = 'Later, while the quizinvideo is still open';
$string['reviewoptions'] = 'Students may review';
$string['reviewoptionsheading'] = 'Review options';
$string['reviewoptionsheading_help'] = 'These options control what information students can see when they review a quizinvideo attempt or look at the quizinvideo reports.
...
**Later, while the quizinvideo is still open** settings apply after this, and before the quizinvideo close date.

**After the quizinvideo is closed** settings apply after the quizinvideo close date has passed. If the quizinvideo does not have a close date, this state is never reached.';
...
$string['saveattemptfailed'] = 'Failed to save the current quizinvideo attempt.';
...
$string['savequizinvideo'] = 'Save this whole quizinvideo';
...
$string['showblocks'] = 'Show blocks during quizinvideo attempts';
$string['showblocks_help'] = 'If set to yes then normal blocks will be shown during quizinvideo attempts';
...
$string['specificquestionnotonquizinvideo'] = 'Specified question is not on the specified quizinvideo';
...
$string['subneterror'] = 'Sorry, this quizinvideo has been locked so that it is only accessible from certain locations.  Currently your computer is not one of those allowed to use this quizinvideo.';
$string['subnetnotice'] = 'This quizinvideo has been locked so that it is only accessible from certain locations. Your computer is not on an allowed subnet. As teacher you are allowed to preview anyway.';
$string['subplugintype_quizinvideo'] = 'Report';
$string['subplugintype_quizinvideo_plural'] = 'Reports';
$string['subplugintype_quizinvideoaccess'] = 'Access rule';
$string['subplugintype_quizinvideoaccess_plural'] = 'Access rules';
...
$string['temporaryblocked'] = 'You are temporarily not allowed to re-attempt the quizinvideo.<br /> You will be able to take another attempt on:';
$string['theattempt'] = 'The attempt';
$string['theattempt_help'] = 'Whether the student can review the attempt at all.';
$string['time'] = 'Time';
$string['timecompleted'] = 'Completed';
$string['timedelay'] = 'You are not allowed to do the quizinvideo since you have not passed the time delay before attempting another quizinvideo';
$string['timeleft'] = 'Time left';
$string['timelimit'] = 'Time limit';
$string['timelimit_help'] = 'If enabled, the time limit is stated on the initial quizinvideo page and a countdown timer is displayed in the quizinvideo navigation block.';
$string['timelimit_link'] = 'mod/quizinvideo/timing';
$string['timelimitexeeded'] = 'Sorry! quizinvideo time limit exceeded!';
...
$string['updatesettings'] = 'Update quizinvideo settings';
...
$string['upgradesure'] = '<div>In particular the quizinvideo module will perform an extensive change of the quizinvideo tables and this upgrade has not yet been sufficiently tested. You are very strongly urged to backup your database tables before proceeding.</div>';
$string['upgradingquizinvideoattempts'] = 'Upgrading quizinvideo attempts: quizinvideo {$a->done}/{$a->outof} (quizinvideo id {$a->info})';
$string['upgradingveryoldquizinvideoattempts'] = 'Upgrading very old quizinvideo attempts: {$a->done}/{$a->outof}';
$string['url'] = 'URL';
...
$string['usersnone'] = 'No students have access to this quizinvideo';
$string['validate'] = 'Validate';
$string['viewallanswers'] = 'View {$a} quizinvideo attempts';
